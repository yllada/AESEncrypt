...
exports.decryptAES = exports.encryptAES = exports.InvalidPaddingError = void 0;
 ...
 */
class InvalidPaddingError extends Error {
    constructor(message) {
        super(message);
...
function deriveKey(password, salt) {
    ...
    return (0, crypto_1.pbkdf2Sync)(password, salt, ITERATION_COUNT, KEY_LENGTH, 'sha256');
}
/**
